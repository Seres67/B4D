...
public class Person implements Serializable, TransportInterface {
    ...
    public void setPosition() throws StopProgramException, CancelProgramException, B4DException {
        Rectangle pos = new Rectangle(20, 50, 80, 25);
        BufferedImage i = B4D.screen.takeSreenshot(pos);
        File out = new File("C:\\Users\\Laurent\\Documents\\file.jpg");
        try {
        ...
        String text = B4D.screen.OCR(pos);
        ...
        int x = Integer.parseInt(text.substring(0, firstComma));
        int y = Integer.parseInt(text.substring(firstComma + 1));
